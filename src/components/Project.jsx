...
export function Project({ project, onDelete }) {
  ...
  return (
    <div className="w-full md:w-4/5 px-10">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded-md mt-4" onClick={() => onDelete(project.id)}>
          Delete Project
        </Button>
      </div>
      ...
      {project.tasks.length === 0 && (
        <p className="text-gray-600 mb-4 text-center text-2xl mt-10">
          No tasks added yet.
        </p>
      )}
    </div>
